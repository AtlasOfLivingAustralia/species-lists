 ...
 * @returns The full URL to the licence deed, or undefined when the code is unknown
 */
export function generateCCLink(shortForm: string, version: string = '4.0'): string | undefined {
