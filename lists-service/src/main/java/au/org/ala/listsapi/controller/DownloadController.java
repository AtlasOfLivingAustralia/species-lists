...
public class DownloadController {
  ...
  protected final SpeciesListRepository speciesListRepository;
  protected final SpeciesListItemRepository speciesListItemRepository;
  ...
  public DownloadController(
      ...
      SpeciesListItemRepository speciesListItemRepository,
      AuthUtils authUtils) {
    this.speciesListRepository = speciesListRepository;
    this.speciesListItemRepository = speciesListItemRepository;
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "403",
        description = "Forbidden - user is not authorized to downwload private species lists",
        content =
            @Content(
                mediaType = MediaType.APPLICATION_JSON_VALUE,
                schema =
  ...
  public ResponseEntity<Object> download(
    ...
    try {
      ...
      if (speciesList.getFieldList() != null) {
  ...
  private void writeCSV(
    ...
    try (CSVWriter csvWriter =
      ...
      while (!finished) {
        ...
        if (lastId == null) {
          items =
              speciesListItemRepository.findFirstBatch(speciesListID, PageRequest.of(0, batchSize));
        } else {
          items =
  ...
  private void writeCsvData(
    ...
    items.forEach(
        speciesListItem -> {
          ...
          if (fieldList != null && speciesListItem.getProperties() != null) {
            fieldList.forEach(
                field ->
