...
/**
 * A simple controller to expose an endpoint for CSRF token generation. The actual CSRF token
 * handling is done by Spring Security filters. This endpoint can be called by the client to
 * initiate a CSRF token being set in a cookie.
 *
