...
/**
 * Pure utility class for building Elasticsearch queries. Contains only static methods with no
 * Spring dependencies. All methods are stateless and thread-safe.
 */
public final class ElasticsearchQueryBuilder {
    ...
    private static void addPropertyFilters(
            String key, List<Filter> filtersForKey, BoolQuery.Builder bq) {
    ...
    private static void addStandardFilters(List<Filter> filtersForKey, BoolQuery.Builder bq) {
